                       ...
                       gpointer          user_data)
{
  ...
  if (g_str_has_suffix (interface_name, "Backend"))
    real_interface_name = g_strndup (interface_name, strlen (interface_name) - strlen("Backend"));
  else
            ...
            gpointer user_data)
{
  ...
  interface_name = g_strconcat (real_iface, "Backend", NULL);
             ...
             gpointer               user_data)
{
  ...
  xdg_app_invocation_lookup_app_id (invocation, NULL,
